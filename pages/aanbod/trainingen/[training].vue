...
useHead({
  ...
  } | Training om te volgen bij Koeching`,
  meta: [
    {
      property: 'og:title',
      content: `${
    ...
    {
      name: 'description',
      content: training.attributes.seo_description || training.attributes.intro,
    },
    {
    ...
    {
      property: 'keywords',
      content: training.attributes.seo_keywords?.map((k: any) => k.keyword).join(', '),
    },
  ],
})
