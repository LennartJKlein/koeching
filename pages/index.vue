<template>
  ...
  <p>
    Voor leren lezen en rekenen ga je naar school. Om te leren zwemmen ga je naar zwemles.
    Om te leren dansen ga je naar dansles. Maar hoe en waar leer je omgaan met emoties,
    zoals bijvoorbeeld boosheid? En hoe gaat dat dan, als je meer zelfvertrouwen wil
    krijgen? Hoe kun je weerbaar worden als je gepest wordt? Zomaar een paar voorbeelden
    van dingen die best moeilijk kunnen zijn voor een kind of een jongere.
  </p>
  <p>
  ...
  <p>
    ...
    ouders.” De appel valt niet ver van de boom” is een bekend spreekwoord. En zo logisch
    ook, als iets moeilijk is voor ons als ouder(s)/verzorger(s), dan kunnen we het ook
    niet voorleven of voordoen aan ons kind. Bij Koeching werken we dan ook graag samen
    met de ouder(s) of verzorger(s), zodat zij zich krachtig voelen en de steunpilaar
    kunnen zijn voor hun kind.
  </p>
