<template>
  <main class="min-h-screen">
    ...
    <p>
      ...
      zwemles. Om te leren dansen ga je naar dansles. Maar hoe en waar leer je omgaan met
      emoties, zoals bijvoorbeeld boosheid? En hoe gaat dat dan, als je meer
    ...
    <p>
      ...
      logisch ook, als iets moeilijk is voor ons als ouder(s)/verzorger(s), dan kunnen we
      het ook niet voorleven of voordoen aan ons kind. Bij Koeching werken we dan ook
